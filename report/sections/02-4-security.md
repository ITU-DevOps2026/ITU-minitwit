...
In addition to the things discussed in this chapter, we decided to make a Security Assesment of our current system, to determine where we should put our effort, in terms of security, if we had more time to do this project. This can be found in the appendix, in the section [Risk Assesment](#risk-assesment) .