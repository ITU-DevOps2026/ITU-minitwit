...
### How we decided to make API
We chose to make the API endpoints work first, and connect these endpoints to the minitwit application. We might need to refactor again later, to maybe make the UI use these API endpoints instead of talking directly to Minitwit application.